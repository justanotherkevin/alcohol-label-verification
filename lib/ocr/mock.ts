...
const MOCK_BOUNDING_BOXES: BoundingBoxMap = {
  brandName:         { x: 0.10, y: 0.05, width: 0.80, height: 0.12 },
  classType:         { x: 0.20, y: 0.20, width: 0.60, height: 0.08 },
  abv:               { x: 0.30, y: 0.30, width: 0.40, height: 0.06 },
  netContents:       { x: 0.30, y: 0.38, width: 0.40, height: 0.06 },
  bottler:           { x: 0.10, y: 0.70, width: 0.80, height: 0.08 },
  countryOfOrigin:   { x: 0.10, y: 0.80, width: 0.50, height: 0.06 },
  governmentWarning: { x: 0.05, y: 0.85, width: 0.90, height: 0.10 },
}
