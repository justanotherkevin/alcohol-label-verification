...
function seed(
  ...
  return {
    ...
    images,
    status: "analyzed",
    analysis: { extracted, confidence: {}, boundingBoxes, result, analyzedAt: submittedAt },
    resolution: null,
  }
}
...
export const SEED_APPLICATIONS: QueueApplication[] = [
  ...
  seed(
    "TTB-2026-1001",
    "Hollow Creek — Apple Pie Moonshine",
  ...
  seed(
    "TTB-2026-1002",
    "ABC Distillery — Single Barrel Straight Rye Whisky",
    "ABC Distillery Inc.",
    ...
    ["labels/abc-distillery.png"],
    {
      ...
      abv: "45% ABV",
      netContents: "750 mL",
      bottler: "Distilled and Bottled by ABC Distillery, Frederick, MD",
      countryOfOrigin: "USA",
      governmentWarning: REQUIRED_GOVERNMENT_WARNING,
    },
  ),
  ...
  seed(
    "TTB-2026-1004",
    "12345 Imports — Rum with Coconut Liqueur",
    "12345 Imports LLC",
  ...
  seed(
    "TTB-2026-1005",
    "Elderberry & Oak — Small Batch Gin",
...
const pendingSeed: QueueApplication = {
  id: "TTB-2026-1006",
  brandName: "Desert Luna & Agave — Premium Botanical Spirit",
