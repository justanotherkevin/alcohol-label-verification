...
export default function SettingsPage() {
  ...
  async function handleReset() {
    ...
    setDevMessage({
      text:
        res.ok ?
          "Queue reset to seed data."
        : "Failed to reset seed data. Try again.",
      ok: res.ok,
    });
    ...
    <div className="px-8 py-8 max-w-2xl">
        ...
        {PROVIDERS.map((p) => (
          <label
            ...
            className={`flex items-start gap-4 p-4 rounded-lg border transition-colors ${
              ...
              : provider === p.id ?
                "cursor-pointer border-primary bg-surface-dim"
              : "cursor-pointer border-outline bg-surface-card hover:border-outline-variant"
            }`}>
            <input
              type="radio"
              name="provider"
      ...
      <div className="mt-10 pt-8 border-t border-outline">
        ...
        <p className="text-sm text-on-surface-muted mt-1">
          ...
          demo applications (ids prefixed &quot;demo-&quot;), so they&apos;re
          ...
          <div className="flex items-start justify-between gap-4 p-4 rounded-lg border border-outline bg-surface-card">
            <div>
              ...
              <p className="text-sm text-on-surface-muted mt-0.5">
                ...
                for example, after you&apos;ve resolved or rejected several
                applications and want the dashboard to look like a fresh install
                again.
              </p>
            </div>
            <button
          ...
          <div className="flex items-start justify-between gap-4 p-4 rounded-lg border border-outline bg-surface-card">
            <div>
              ...
              <p className="text-sm text-on-surface-muted mt-0.5">
                ...
                new application without waiting for a real submission.
              </p>
            </div>
            <button
          ...
          <div className="flex items-start justify-between gap-4 p-4 rounded-lg border border-outline bg-surface-card">
            <div>
              ...
              <p className="text-sm text-on-surface-muted mt-0.5">
                ...
                you&apos;ve just added a mock application or changed the OCR
                provider and want to see results immediately.
              </p>
            </div>
            <button
