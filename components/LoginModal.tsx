  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
      <div className="relative bg-surface-card border border-outline rounded-2xl shadow-2xl w-full max-w-2xl">
        ...
        <h2
          className="px-8 text-xl font-bold text-on-surface mb-1"
          style={{ fontFamily: "var(--font-inter)" }}>
          Sign in
        </h2>
        <p className="px-8 text-sm text-on-surface-muted mb-6">
            ...
            <div className="space-y-1.5">
              {DEMO_APPLICANTS.map((a) => (
                <button
                  ...
                  <span className="flex-1 min-w-0 font-medium text-on-surface truncate">
                    {a.name}
                  </span>
