          ...
          <ul className="space-y-1">
            {stillFlagged.map((f) => {
              ...
              return (
                <li
                  key={f.field}
                  className="text-sm text-on-surface-dim flex items-center justify-between gap-2">
                  <span>{f.label}</span>
                  <span className="flex items-center gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="cursor-pointer text-xs text-primary hover:text-primary-hover underline">
                      Review
                    </button>
                  </span>
                </li>
