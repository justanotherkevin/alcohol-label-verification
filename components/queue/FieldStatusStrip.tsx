...
export function FieldStatusStrip({
  ...
  return (
    <div className="flex flex-col gap-4 border-b border-outline bg-surface-dim px-6 py-5">
      <span className="font-mono text-base font-semibold text-on-surface shrink-0">
        {appId}
      </span>
